...
public class Wolf extends Animal{
    public Wolf(int x, int y, World world, boolean canMultiply){
    _world=world;
    _strength=9;
    _initiative=5;
    _age=0;
    ...
    _iconFileName="wolf.png";
    world.setCreature(this);
    ImageIcon ii = new ImageIcon(this.getClass().getResource(_iconFileName));
    _image = ii.getImage();
    }
    
    public Wolf(int x, int y, World world, boolean canMultiply, int age, int strength){
    _world=world;
    _strength=strength;
    _initiative=5;
    _age=age;
    ...
    int direction = generator.nextInt(4);
        ...
        this._world.createCreature(x, y, new Wolf(x,y,this._world,true));
    }
