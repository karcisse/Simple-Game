...
public class Grass extends Plant{
    ...
    public Grass(int x, int y, World world, boolean canMultiply){
    _world=world;
    _strength=0;
    _initiative=0;
    _age=0;
    ...
    public Grass(int x, int y, World world, boolean canMultiply, int age, int strength){
    _world=world;
    _strength=strength;
    _initiative=0;
    _age=age;
    ...
    public void action(){
        ...
        if (generator.nextInt(8)==6) {
            ...
            if (!this._world.checkIfSomethingIsThere(newX, newY)) {
                    ...
                    this._world.createCreature(newX, newY, new Grass(newX, newY, this._world, false));
                }
            }
